...
title:SetText("41's Smart Functions Settings & Snippets")
...
AddApiAuto(GlobalPanel, "GLOBAL", "/script fo_cast('Renew')", "Targets Mouseover > Target > Self")
AddApiAuto(GlobalPanel, "GLOBAL", "/script fo_cast('Renew', 's')", "Force self cast")
AddApiAuto(GlobalPanel, "GLOBAL", "/script fo_cast('Moonfire', 'm')", "Enable mouseover on enemy")
AddApiAuto(GlobalPanel, "GLOBAL", "/script fo_castDual('Rejuvenation', 'Moonfire',)", "Helpful/Harmful. 'm','s' still works")
AddApiAuto(GlobalPanel, "GLOBAL", "fo_aura('moonfire')", "Aura Checker (same rule as fo_cast)")
AddApiAuto(GlobalPanel, "GLOBAL", "fo_auraUnit('Faerie Fire', 'targettarget')", "Aura Checker (Manual Target)")
...
AddApiAuto(DruidPanel, "DRUID", "/script fo_tree('rejuvenation', 'hibernate', 'm')", "Cast spell if Tree form")
